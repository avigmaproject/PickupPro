...
import { showTabBar } from "../../store/action/tabbar/action";
...
class Search extends Component {
  ...
  //               }}
  //             />
  //             <Text style={{ lineHeight: 30 }}>Roja</Text>
  //           </View>
  //         </View>
  //         <View
  //           style={{
  ...
  //             You are already in game , so you can not access app for now. As
  //             game ended you check again and access the app again
  //           </Text>
  //           <TouchableOpacity
  //             onPress={() =>
        ...
        <ScrollView>
          ...
          >
            ...
            >
              ...
              <View style={{ marginTop: uiMargin }}>
                <Text style={{ color: "gray", fontSize: 20 }}>Search</Text>
              </View>
              <TouchableOpacity
